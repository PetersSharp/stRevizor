                    ...
                    case ImportFileType.Zip:
                        {
                            ...
                            if (rv.UrlCount > 0)
                            {
                                rv.SendToTftpUrlList();
                            }
                            if (rv.PortIpCount > 0)
                            {
                                rv.SendToTftpPortIpList();
                            }
                            if (rv.DnsCount > 0)
                            {
                                rv.SendToTftpDnsList();
                            }
                            break;
                        }
                    case ImportFileType.Fw:
                                ...
                                case ExportFileType.Ip:
                                    {
                                        ...
                                        rv.SendAsTftpIpList(importList);
                                        break;
                                    }
                                case ExportFileType.Url:
                                    {
                                        flatThreadSafe.Run(this, (Action)(() => this.FLBLUrlSet.Text = importList.Count.ToString()));
                                        rv.SendAsTftpUrlList(importList);
                                        break;
                                    }
                                case ExportFileType.Port:
                                    {
                                        flatThreadSafe.Run(this, (Action)(() => this.FLBLPortSet.Text = importList.Count.ToString()));
                                        rv.SendAsTftpPortIpList(importList);
                                        break;
                                    }
                                default:
                                    {
                    ...
                    case ImportFileType.Xml:
                        {
                            if (this.rv != null)
                            {
                                ...
                                flatThreadSafe.Run(this, (Action)(() => this.FLBLPortSet.Text = this.rv.PortCount.ToString()));
                                flatThreadSafe.Run(this, (Action)(() => this.FLBLDNSSet.Text = this.rv.DnsCount.ToString()));
                            }
                            break;
                        }
                    case ImportFileType.Fw:
